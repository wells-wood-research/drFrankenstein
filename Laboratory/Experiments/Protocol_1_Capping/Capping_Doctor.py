...
def capping_protocol(config: dict) -> dict:
    ...
    nmeCappedDf = add_n_methyl_caps(molDf, nmePdb, config)
    ...
    optimedPdb = Capping_Monster.optimize_capped_structures(cappedPdb, config)
...
#🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲🗲
def add_n_methyl_caps(molDf: pd.DataFrame,
                      nmePdb: FilePath,
