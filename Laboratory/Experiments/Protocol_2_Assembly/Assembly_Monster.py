...
def replace_parameters(moleculeFrcmod: FilePath, parameterDataset: FilePath) -> None:
    """
...
def change_backbone_types_amber(mol2File: FilePath, config: dict) -> None:
    ...
    """
    amberDefaultMap = {'N': 'N', 'HN': 'H', 'CA': 'CT', 'HA': 'H1', 'C': 'C', 'O': 'O', 'NN': 'N', 'HNN1': 'H', 'CN': 'CT', 'HCN1': 'H3', 'HCN2': 'H3', 'HCN3': 'H3', 'CC1': 'C', 'OC': 'O', 'CC2': 'CT', 'HC1': 'H3', 'HC2': 'H3', 'HC3': 'H3'}
...
def create_missing_prm(parmedPsf: CharmmPsfFile, cappedRtf: FilePath, cappedPrm: FilePath, charmmDefaultParams: dict, nameToCgenffType: dict, config: dict) -> FilePath:
    """
    ...
    missingParams = Assembly_Assistant.assign_missing_bonds(missingParams, parmedPsf, nameToCgenffType, completeParameterSet)
    missingParams = Assembly_Assistant.assign_missing_angles(missingParams, parmedPsf, nameToCgenffType, completeParameterSet)
    missingParams = Assembly_Assistant.assign_missing_dihedrals(missingParams, parmedPsf, nameToCgenffType, completeParameterSet)
...
def set_backbone_types_psf(parmedPsf: CharmmPsfFile, config: dict) -> Tuple[CharmmPsfFile, dict]:
    """
    ...
    """
    nametodesiredtypeMol = {'N': 'NH1', 'HN': 'H', 'CA': 'CT1', 'HA': 'HB1', 'C': 'C', 'O': 'O'}
    nametodesiredtypeBb = {'NN': 'NH1', 'HNN1': 'H', 'CN': 'CT1', 'HCN1': 'HB1', 'HCN2': 'HB1', 'HCN3': 'HB1', 'CC1': 'C', 'OC': 'O', 'CC2': 'CT1', 'HC1': 'HB1', 'HC2': 'HB1', 'HC3': 'HB1'}
