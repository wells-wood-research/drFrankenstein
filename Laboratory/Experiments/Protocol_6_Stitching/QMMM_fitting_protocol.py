...
def fit_torsion_parameters(config: dict, torsionTag: str, mmTotalEnergy: np.ndarray, mmTorsionEnergy: np.ndarray, shuffleIndex: int, mmCosineComponents: dict, debug: bool=False):
    ...
    (torsionParametersDf, cosineComponents) = drFourier.fourier_transform_protocol(qmTorsionEnergy, torsionTag, qmmmTorsionFittingDir, forcefeild=config['parameterFittingInfo']['forceField'])
