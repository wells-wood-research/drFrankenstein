...
def initialise_runtime_info(config):
    runtimeBanner = '\n'.join(['##########################################################################################################################', '                                    _     _                      ___            __                                       #', '             _ __   _   _   _ __   | |_  (_)  _ __ ___     ___  |_ _|  _ __    / _|   ___                                #', "            | '__| | | | | | '_ \\  | __| | | | '_ ` _ \\   / _ \\  | |  | '_ \\  | |_   / _ \\                               #", '            | |    | |_| | | | | | | |_  | | | | | | | | |  __/  | |  | | | | |  _| | (_) |                              #', '            |_|     \\__,_| |_| |_|  \\__| |_| |_| |_| |_|  \\___| |___| |_| |_| |_|    \\___/                               #', '                                                                                                                         #', '##########################################################################################################################'])
...
def init_config_checkpoints(config, outDir):
    drFrankensteinYaml = p.join(outDir, 'drFrankenstein.yaml')
    checkpointBanner = '\n'.join(['##########################################################################################################################', '                                                                                                                         #', '               _                     _                      _           _     ___            __                          #', '         ___  | |__     ___    ___  | | __  _ __     ___   (_)  _ __   | |_  |_ _|  _ __    / _|   ___                   #', "        / __| | '_ \\   / _ \\  / __| | |/ / | '_ \\   / _ \\  | | | '_ \\  | __|  | |  | '_ \\  | |_   / _ \\                  #", '       | (__  | | | | |  __/ | (__  |   <  | |_) | | (_) | | | | | | | | |_   | |  | | | | |  _| | (_) |                 #', '        \\___| |_| |_|  \\___|  \\___| |_|\\_\\ | .__/   \\___/  |_| |_| |_|  \\__| |___| |_| |_| |_|    \\___/                  #', '                                           |_|                                                                           #', '                                                                                                                         #', '##########################################################################################################################'])
    if not p.exists(drFrankensteinYaml):
        config['checkpointInfo'] = {'cappingComplete': False, 'assemblyComplete': False, 'conformersComplete': False, 'scanningComplete': False, 'chargesComplete': False, 'torsionFittingComplete': False, 'finalCreationComplete': False, 'reportingComplete': False}
