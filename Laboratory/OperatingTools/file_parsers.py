...
def write_rtf(data: dict, outputFile: FilePath) -> None:
    """Write parsed CHARMM RTF data back to disk."""
...
def parse_mol2(mol2File: FilePath) -> tuple[pd.DataFrame, pd.DataFrame]:
    """Parse a MOL2 file into atom and bond data frames."""
    atomData = []
    bondData = []
    readingAtoms = False
    readingBonds = False
