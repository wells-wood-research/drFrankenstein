...
def apply_defaults_and_validate(config):
    ...
    set_default(parameterFittingInfo, 'fittingProtocol', 'ROBUST_SPARSE_HARMONIC', errors['parameterFittingInfo'])
    ...
    set_default(parameterFittingInfo, 'converganceTolerance', None, errors['parameterFittingInfo'])
    set_default(parameterFittingInfo, 'torsionConvergenceTolerance', None, errors['parameterFittingInfo'])
    set_default(parameterFittingInfo, 'progressiveCosineFitting', False, errors['parameterFittingInfo'])
    set_default(parameterFittingInfo, 'freezeConvergedTorsions', False, errors['parameterFittingInfo'])
    set_default(parameterFittingInfo, 'amplitudeExplosionRatioThreshold', None, errors['parameterFittingInfo'])
    set_default(parameterFittingInfo, 'robustHuberDelta', 1.0, errors['parameterFittingInfo'])
    set_default(parameterFittingInfo, 'robustLambdaCount', 25, errors['parameterFittingInfo'])
    set_default(parameterFittingInfo, 'robustLambdaRatio', 0.02, errors['parameterFittingInfo'])
    set_default(parameterFittingInfo, 'robustOuterIterations', 15, errors['parameterFittingInfo'])
    set_default(parameterFittingInfo, 'robustInnerIterations', 300, errors['parameterFittingInfo'])
    set_default(parameterFittingInfo, 'robustConvergenceTolerance', 1e-6, errors['parameterFittingInfo'])
    set_default(parameterFittingInfo, 'overfitInitialFunctions', 12, errors['parameterFittingInfo'])
    set_default(parameterFittingInfo, 'overfitMinFunctions', 1, errors['parameterFittingInfo'])
    set_default(parameterFittingInfo, 'overfitPruneMaeIncreaseTolerance', 0.02, errors['parameterFittingInfo'])
    set_default(parameterFittingInfo, 'overfitRidge', 1e-4, errors['parameterFittingInfo'])
    set_default(parameterFittingInfo, 'overfitMaxTermAmplitudeFactor', 1.5, errors['parameterFittingInfo'])
    set_default(parameterFittingInfo, 'overfitMaxTotalAmplitudeFactor', 3.0, errors['parameterFittingInfo'])
